public class Edit {
    ...
    // Edit Constructor
    public Edit (String projectName, String projectNumber, String building, String physicalAddress, String erf,
    ...
    public String toString(){
        return getProjectName() + ", " + getProjectNumber() + ", " + getBuilding() + ", "
                ...
                + ", " + getArchitectName() + ", " + getArchitectTelephoneNumber()
                + ", " + getArchitectEmail()  + ", " + getArchitectPhysicalAddress()
                + ", " + getContractorName() + ", " + getContractorTelephoneNumber()
                + ", " + getContractorEmail()  + ", " + getContractorPhysicalAddress()
                + ", " + getCustomerName()  + ", " + getCustomerTelephoneNumber()
                + ", " + getCustomerEmail()  + ", " + getCustomerPhysicalAddress();
    }
}
